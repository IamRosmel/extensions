...
M.change_theme = require "setup.change_theme"
...
M.reload_theme = require "setup.reload_theme"

-- update setup
M.update_setup = require "setup.updater.update"

-- create snapshot
M.snap_create = require "setup.updater.snap_create"

-- checkout snapshot
M.snap_checkout = require "setup.updater.snap_checkout"

-- delete snapshot
M.snap_delete = require "setup.updater.snap_delete"

M.write_data = function(old_data, new_data)
  local file_fn = require("setup").file
