local function snap_create()
  ...
  local utils = require "setup"
  local git = require "setup.utils.git"
  local misc = require "setup.utils.misc"
  local defaults = require "setup.utils.config"
  local prompts = require "setup.utils.prompts"
