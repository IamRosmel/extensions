...
-- Custom theme picker
-- uses setup_theme global variable
...
local function theme_switcher(opts)
  ...
  local local_utils = require "setup"
  ...
  if next(themes) ~= nil then
    ...
    local current_theme = vim.g.setup_theme
    local new_theme = ""
    local change = false
    ...
    picker.close_windows = function(status)
      ...
      if reload_theme(final_theme) then
        if change then
          ...
          if ans then
            ...
            -- will be used in restoring setup theme var
            final_theme = current_theme
          end
        end
      else
      ...
      -- set setup_theme global var
      vim.g.setup_theme = final_theme
